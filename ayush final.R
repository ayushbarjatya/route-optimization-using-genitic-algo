...
library(RMySQL)
library(sqldf)
mydb <- dbConnect(MySQL(), user = "root" , password = "barjatya97" , dbname = "spring_clean" , host = "localhost")
str(mydb)
...
d = matrix_travel_time[1:6,7:195]
View(d)

s11 <- t(matrix_travel_time[7:195,1:6])
View(s11)
